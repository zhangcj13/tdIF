...
# from detection.ops import nms
try:
    from nms import nms
    print("compiled nms load success!")
except:
    from detection.ops.nms_local import nms_forward as nms
    print("using python write nms...")

from detection.core.lane import Lane
from detection.models.losses.focal_loss import FocalLoss
...
class LaneATT(nn.Module):
    def __init__(self,
        ...
        if isinstance(backbone_nb_channels, list):
            backbone_nb_channels=backbone_nb_channels[-1]
